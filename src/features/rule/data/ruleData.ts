...
export const ruleData: Rule[] = [
  ...
  },
  {
    ...
    title: "Travel Table",
    type: "reference",
    desc: "Used to determine getting lost and travel events for each terrain type. Roll 2d6 for Lost and Event thresholds; roll 1d6 for the specific Event Reference (r231–r280).",
    tables: [
      {
        type: "roll-table",
        label: "Travel Table",
