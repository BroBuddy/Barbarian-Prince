...
export const ruleData: Rule[] = [
  ...
  },
  {
    ...
    type: "action",
    desc: "As a daily action, you spend the day searching ruins with your party. Roll two dice to determine the result.",
    tables: [
      {
        type: "roll-table",
        label: "Search Ruins (2d6)",
        cols: ["Roll", "Event"],
        rows: [
          ["2", "e133"],
          ["3", "e135"],
